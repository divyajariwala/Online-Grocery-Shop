    ...
    return (
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          <Text style={styles.text1} onPress={() => this.props.navigation.dispatch(popAction)}> Back </Text>
          ...
          <FlatList
            ...
            renderItem={({ item }) =>
              ...
              <View style={{ justifyContent: "space-around", alignItems: "center", marginLeft: hp(2.5), marginRight: hp(2.5), marginTop: hp(1) }} >
                <Image source={{ uri: item.Image }} style={{ height: hp(25), width: "100%", marginLeft: hp(2.5), marginRight: hp(2.5) }}></Image>
          ...
          <FlatList
            ...
            renderItem={({ item }) => <View >
              ...
              <ScrollView
                ...
                horizontal={true} Style={styles.contentContainer}>
        ...
        <View style={{ height: hp(6), flexDirection: "row", justifyContent: "space-evenly", marginTop: hp(2) }}>
          ...
          <TouchableOpacity activeOpacity={1}
            ...
            style={{ borderRadius: hp(1), backgroundColor: "#be202f", height: hp(5), width: wp(28) }}>
            <Text style={{ color: "#fefefd", fontSize: hp(2.5), textAlign: "center", marginTop: hp(0.8) }}>Cart(#)</Text>
          </TouchableOpacity>
          <TouchableOpacity activeOpacity={1}
