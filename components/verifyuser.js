...
import { View, Text, StyleSheet, Image, Button, BackHandler, Alert, ActivityIndicator,AsyncStorage} from 'react-native';
                ...
                .then(response => {
                    ...
                    if (response.data.result == "success") {
                        ...
                        if (response.data.message == "Customer Login successfully!") {
                            this.storeToken(JSON.stringify(response.data.data));
