...
import { View, Text, StyleSheet, Image, Button,BackHandler,Alert,ActivityIndicator } from 'react-native';
...
export default class verifysignupuser extends Component {
    onButtonPress = () => {
    ...
    toggleModal = () => {
        ...
        const businessname=data[4]
        const mobilenumber = data[5]
            this.props.navigation.navigate('signup2',{
                data1:[userid,name,surname,category,businessname,mobilenumber]
            })
        }, 2000)
    };
    render() {
